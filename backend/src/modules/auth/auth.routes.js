...
import { loginSchema, refreshSchema, registerSchema, updateProfileSchema } from './auth.validation.js';
...
authRouter.patch('/me', authenticate, validate(updateProfileSchema), controller.updateProfile);
